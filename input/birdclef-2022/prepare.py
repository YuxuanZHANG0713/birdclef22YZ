...
if __name__ == "__main__":
    ...
    target_sr = args.sr #target sample rate of resample

    train = pd.read_csv("train_metadata.csv") #train metadata

    train['filename'] = train.filename.apply(lambda x:x.split('/')[1]) #remove folder name from filename
